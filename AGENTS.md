...
├── backend/
│   ├── AGENTS.md             # Detailed backend architecture
...
├── frontend/
│   ├── AGENTS.md             # Detailed frontend architecture
│   └── src/
...
- [Backend Architecture](backend/AGENTS.md) - Detailed backend internals, middleware chain, sandbox, subagents, memory
- [Frontend Architecture](frontend/AGENTS.md) - Detailed frontend internals, components, state management
