...
This file is for coding agents. If the DeerFlow repository is not already cloned and open, clone `https://github.com/wangxi-lab/deer-flow.git` first, then continue from the repository root.
...
- If the current directory is not the DeerFlow repository root, clone `https://github.com/wangxi-lab/deer-flow.git` if needed, then change into the repository root.
