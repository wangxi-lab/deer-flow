...
class AppConfig(BaseModel):
    ...
    rag: RAGConfig = Field(default_factory=RAGConfig, description="External RAG provider configuration")
    ...
    def from_file(cls, config_path: str | None = None) -> Self:
        ...
        # Always refresh RAG config so removed sections reset to defaults.
        load_rag_config_from_dict(config_data.get("rag") or {})
