...
export const enUS: Translations = {
  ...
  inputBox: {
    ...
    skill: "Skill",
    skillDescription:
      "Choose the Skill this question must use. Selecting a Skill clears knowledge-base selection to avoid route conflicts.",
    skillClear: "Clear selection",
    skillSelected: "{count} selected",
    surpriseMe: "Surprise",
