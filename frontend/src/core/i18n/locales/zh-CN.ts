...
export const zhCN: Translations = {
  ...
  inputBox: {
    ...
    searchModels: "搜索模型...",
    knowledgeBase: "知识库",
    knowledgeBaseDescription: "选择当前线程优先检索的外部知识库资源。",
    knowledgeBaseUnavailable: "知识库已配置，但当前不可用。",
    knowledgeBaseEmpty: "当前没有可用的知识库资源。",
    knowledgeBaseClear: "清空选择",
    knowledgeBaseSelected: "已选 {count} 个",
    skill: "Skill",
    skillDescription:
      "选择当前问题要强制使用的 Skill。选择 Skill 后会清空知识库选择，避免路线冲突。",
    skillClear: "清空选择",
    skillSelected: "已选 {count} 个",
    surpriseMe: "小惊喜",
  ...
  toolCalls: {
    ...
    searchKnowledgeBaseFor: (query: string) => `检索知识库：“${query}”`,
    noKnowledgeBaseSources: "没有返回可展示的知识库来源。",
    citedKnowledgeBaseSources: "引用来源",
    knowledgeBaseSource: "知识库来源",
    openSource: "打开来源",
    relevanceScore: (score: number) => `相关度 ${score.toFixed(3)}`,
