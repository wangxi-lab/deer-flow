...
description: >-
  ...
  their AI partner's identity, for example "create my SOUL.md", "bootstrap my
  agent", "set up my AI partner", "define who you are", "let's do onboarding",
  "personalize this AI", or "make you mine", or when a SOUL.md is missing.
  Also trigger for updates such as "update my SOUL.md", "change my AI's
  personality", or "tweak the soul".
---
